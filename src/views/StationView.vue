<template>
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Antonio:wght@100..700&family=Familjen+Grotesk:ital,wght@0,400..700;1,400..700&family=Faustina:ital,wght@0,300..800;1,300..800&family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap"
      rel="stylesheet"
    />
  </head>
